            ...
            <table cellspacing='0' cellpadding='0'
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-success" style="padding:5px;margin:5px">{{ number_format($dp, 2, ',', '.') }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-success" style="padding:5px;margin:5px">{{ number_format($pecah->uangpembeli, 2, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td colspan="5" style="text-align:right">Kembalian : &nbsp;</td>
                        <td class="text-success" style="padding:5px;margin:5px">{{ number_format($pecah->kembalian, 2, ',', '.') }}</td>
                    </tr>
                </tbody>
            </table>
            <br><br>
