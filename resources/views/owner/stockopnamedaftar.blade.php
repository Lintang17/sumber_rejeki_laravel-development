                                    ...
                                    @foreach ($stockOpnameDates as $date)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table class="table table-borderless mb-0">
                                                    ...
                                                    @foreach ($stockOpnameData[$tanggalStockOpname] as $item)
                                                        <tr>
                                                            <td width="30%">{{ $item->produk->namaproduk }}</td>
                                                            <td class="text-center" width="20%">
                                                                {{ $item->stokgudang }}</td>
                                                            <td class="text-center" width="20%">
                                                                {{ $item->stoksistem }}</td>
                                                            <td class="text-center" width="20%">{{ $item->selisih }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </table>
                                            ...
                                            {{-- <td class="text-center">
                                                    <a href="{{ url('owner/stockopnamehapus', $tanggalStockOpname) }}"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="forms-sample" method="post" action="{{ url('owner/stockopnamesimpan') }}"
