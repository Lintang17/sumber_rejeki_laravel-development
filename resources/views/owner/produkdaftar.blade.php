                            ...
                            <tbody>
                                @foreach ($produk as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-link" data-toggle="modal"
                                                ...
                                                <img src="{{ asset('assets/foto/' . $value->fotoproduk) }}" width="100px">
                                            </button>
                                        </td>
                                        <td>
                                            @php
                                            ...
                                            @if (file_exists(public_path('assets/foto/qr/' . $value->barcode . '.png')))
                                                <button type="button" class="btn btn-link" data-toggle="modal"
                                                    ...
                                                    <img src="{{ $barcodePath }}" alt="Barcode" width="100" height="100">
                                                </button>
                                            @else
                                        ...
                                        <td>
                                            @if (file_exists(public_path('assets/foto/qr/' . $value->barcode . '.png')))
                                                <a href="{{ $barcodePath }}" target="_blank" class="btn btn-primary" download>
                                                    Cetak Barcode
                                                </a>
                                            @else
                                                <p>Barcode tidak tersedia</p>
                                        ...
                                        @if (auth()->user()->role != 'Owner')
                                            <td>
                                                <a href="{{ url('owner/produkedit', $value->idproduk) }}" class="btn btn-success m-1">Edit</a>
                                                <a href="{{ url('owner/produkhapus', $value->idproduk) }}" class="btn btn-danger m-1"
                                    ...
                                    <div class="modal fade" id="modalFoto{{ $value->idproduk }}" tabindex="-1"
                                        role="dialog" aria-labelledby="modalFotoLabel{{ $value->idproduk }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalFotoLabel{{ $value->idproduk }}">
                                                        Foto Produk - {{ $value->namaproduk }}
                                                    </h5>
