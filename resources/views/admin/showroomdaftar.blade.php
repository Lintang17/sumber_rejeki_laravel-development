                            ...
                            <tbody>
                                @forelse ($showroom as $index => $item)
                                    <tr>
                                        ...
                                        {{-- <td>{{ $item->stok_total ?? ($item->stok_awal + $item->stok_tambahan) }}</td> --}}
                                        <td>{{ $item->stok_terjual ?? 0 }}</td>
                                        <td>{{ $item->stok_sisa ?? 0 }}</td>
                                        <td>
                                            @if($item->produksi && $item->produksi->hargajual)
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Foto Produk - {{ $item->produksi->namaproduk ?? '-' }}</h5>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="11" class="text-center">Belum ada barang masuk showroom.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
