            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="{{ url('admin/produkupdate', $produk->idproduk) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $produk->stok }}" class="form-control" name="stok" readonly>
                            </div>
                            ...
                            <a href="{{ url('admin/produkdaftar') }}" class="btn btn-light">Batal</a>
                        </form>
