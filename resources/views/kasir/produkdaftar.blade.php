                            ...
                            <tbody>
                                @foreach ($produk as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->jumlah }}</td>
                                        <td>{{ rupiah($value->produksi->hargajual) }}</td>
                                        <td>
                                            <button type="button" class="btn btn-link" data-toggle="modal"
                                                data-target="#modalFoto{{ $value->idshowroom }}">
                                                <img src="{{ asset('assets/foto/' . $value->produksi->fotoproduk) }}" width="100px">
                                            </button>
                                        </td>
                                        <td>
                                            @php
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <img src="{{ asset('assets/foto/' . $value->fotoproduk) }}"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
